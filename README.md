...
- Expo client: `/root/autodl-tmp/sign2text.app/apps/expo-client`
- Native iOS app: `/root/autodl-tmp/sign2text.app/apps/ios-native`
- Backend service: `/root/autodl-tmp/sign2text.app/backend/sign2text-ml`
- Research archive: `/root/autodl-tmp/sign2text.app/research/srtp-SLR`
