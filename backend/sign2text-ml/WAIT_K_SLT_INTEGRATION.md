...
- SLT config: `/root/autodl-tmp/SLRT/Online/SLT/configs/g2t_wait2.yaml`
- Phoenix Online gloss predictions format reference: `/root/autodl-tmp/SLRT/Online/SLT/configs/g2t_wait2.yaml`
- tokenizer and embedding assets under `/root/autodl-tmp/models/pretrained_models/mBart_de`
...
ls /root/autodl-tmp/SLRT/Online/SLT/configs
ls /root/autodl-tmp/models/pretrained_models/mBart_de
find /root/autodl-tmp/SLRT/Online/SLT/results -maxdepth 3 -type f | head
```
...
- `slt_root`: `/root/autodl-tmp/SLRT/Online/SLT`
- `slt_config_path`: default to `/root/autodl-tmp/SLRT/Online/SLT/configs/g2t_wait2.yaml`
